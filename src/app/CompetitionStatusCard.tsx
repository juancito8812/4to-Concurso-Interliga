    ...
    <div className="relative p-5 sm:p-7 rounded-xl sm:rounded-2xl bg-navy-mid border border-border h-full flex flex-col justify-between">
      <div>
        ...
        <p className="text-sm leading-relaxed text-silver mb-3">
          ...
          si fallás tu pronóstico en fase KO, quedás fuera.{" "}
        ...
        {!loading && (
          user ? (
            primaryTeam ? (
              ...
              <div className="bg-navy-card/80 border border-border/80 rounded-xl p-3.5 text-center">
            ...
            <div className="bg-gold/10 border border-gold/30 rounded-xl p-3.5 text-center">
            ...
            <div className="bg-navy-card/80 border border-border/80 rounded-xl p-3.5 text-center flex flex-col gap-3">
