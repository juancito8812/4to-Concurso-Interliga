        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <a
              ...
              aria-label="Grupo oficial de WhatsApp de Interliga"
              className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-navy-mid border border-border text-silver hover:text-[#25D366] hover:border-[#25D366] transition-colors"
            >
